...
public class TriangleValidator {
  ...
  /**
   * Checks if the Triangle is Isoceles or not.
  ...
  public boolean isIsosceles(Triangle t){
    if(t.getA() == 0 || t.getB() == 0 || t.getC() == 0){
      return false;
    }else if(t.getA() == t.getB() && t.getB() != t.getC() || t.getB() == t.getC() && t.getA() != t.getC() || t.getA() == t.getC() && t.getB() != t.getC()){
      return true;
    }else {
      return false;
    }
  ...
  public boolean isScalene(Triangle t){
    if(t.getA() == 0 || t.getB() == 0 || t.getC() == 0){
      return false;
    }else if(t.getA() > t.getB() + t.getC() || t.getB() > t.getA() + t.getC() || t.getC() > t.getA() + t.getB()){
      return false;
    }else {
      return true;
    }
