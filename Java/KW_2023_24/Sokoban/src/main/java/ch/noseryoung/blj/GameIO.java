...
public class GameIO extends JFrame {
    ...
    public GameIO(Game game, int scale, double cellMargin) {
        ...
        inputMap = Map.of(KeyEvent.VK_UP, game::moveUp, KeyEvent.VK_DOWN, game::moveDown,
                KeyEvent.VK_LEFT, game::moveLeft, KeyEvent.VK_RIGHT, game::moveRight, KeyEvent.VK_ESCAPE, game::escAction, KeyEvent.VK_1, game::restartAction);
        colorMap = Map.of(0, Color.LIGHT_GRAY, 1, Color.BLACK, 2, Color.PINK, 3, Color.BLUE, 4,
                Color.green);
