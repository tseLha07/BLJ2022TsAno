...
public class CSRenderer extends JPanel {
   ...
   */
  public CSRenderer(CoordinateSystem
                            cs, int fieldScale, int pointSize) {
    this.cs = cs;
  ...
  public void paintComponent(Graphics g) {
    ...
    for (CSLineSegment line : cs.getAllLine()) {
      CSPoint translatedPoint = translatePoint(line.getLineStart());
